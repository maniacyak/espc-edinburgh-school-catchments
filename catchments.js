...
(function() {
    ...
    this.controls.innerHTML = '<label for="catchment-areas" style="display: block; float: none; font-weight: bold; margin: 0; padding: 0 2px 2px; width: auto;">Show school catchment areas: [ <a href="http://maniacyak.github.io/espc-edinburgh-school-catchments/" style="color: #fff;">?</a> ]</label>';
